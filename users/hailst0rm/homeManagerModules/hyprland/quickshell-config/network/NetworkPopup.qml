                                ...
                                ColumnLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        TextInput {
                                            ...
                                            font.family: "Iosevka Nerd Font"; font.pixelSize: window.s(13); color: window.text
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        font.family: "Iosevka Nerd Font"; font.weight: Font.Black
                                    ...
                                    Text {
                                        Layout.alignment: Qt.AlignHCenter
                                        font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(11)
                                        ...
                                        ColumnLayout {
                                            ...
                                            Item {
                                                ...
                                                Text {
                                                    ...
                                                    anchors.verticalCenter: parent.verticalCenter
                                                    text: floatCard.itemName
                                                    font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(13); color: window.crust 
                                                }
                                                Text { 
                                            ...
                                            Text {
                                                font.family: "Iosevka Nerd Font"; font.pixelSize: window.s(10); color: window.crust
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "Iosevka Nerd Font"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "wifi" ? window.crust : window.text; text: "Wi-Fi"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "Iosevka Nerd Font"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "bt" ? window.crust : window.text; text: "Bluetooth"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
