                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        Layout.alignment: Qt.AlignHCenter
                                        text: modelData.time
                                        font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(12)
                                    ...
                                    Text { 
                                        ...
                                        font.family: "Iosevka Nerd Font"; font.weight: Font.Black; font.pixelSize: window.s(14)
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                anchors.centerIn: parent
                                spacing: window.s(6)
                                Text { text: "Open Web"; font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(14); color: schLinkMa.containsMouse ? window.base : window.text }
                                        ...
                                        Item {
                                            ...
                                            ColumnLayout {
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: modelData.time || ""; font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(14); color: classNode.isActive ? window.text : window.overlay1 }
                                                }
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: modelData.room || ""; font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(14); color: window.subtext1; elide: Text.ElideRight; Layout.fillWidth: true }
                                                }
                                            }
