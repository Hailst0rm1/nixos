                        ...
                        ColumnLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    font.family: "Iosevka Nerd Font"; font.weight: Font.Black; font.pixelSize: window.s(20)
                                    color: window.text
                    ...
                    ListView {
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                Text { Layout.alignment: Qt.AlignHCenter; font.family: "Iosevka Nerd Font"; font.pixelSize: window.s(14); color: window.overlay0; text: "No active streams" }
                            }
                        }
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Text {
                                            Layout.fillWidth: true; elide: Text.ElideRight
                                            font.family: "Iosevka Nerd Font"; font.weight: Font.Bold; font.pixelSize: window.s(14)
                                            color: isActiveNode ? window.crust : window.text
