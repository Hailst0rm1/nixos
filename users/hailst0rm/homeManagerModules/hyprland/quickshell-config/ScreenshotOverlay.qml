...
PanelWindow {
    ...
    component ToolbarBtn: Rectangle {
        ...
        RowLayout {
            ...
            Text { id: txt; visible: tBtn.label !== ""; font.family: "Iosevka Nerd Font"; font.weight: Font.DemiBold; text: tBtn.label; color: tBtn.isDanger ? _theme.red : _theme.text; font.pixelSize: s(13) }
        }
    ...
    Item {
        ...
        Rectangle {
            ...
            Text {
                ...
                font.family: "Iosevka Nerd Font"; font.weight: Font.DemiBold; font.pixelSize: s(24); color: _theme.text
            }
        }
        Item {
            anchors.fill: parent
