            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Text { text: root.musicData.deviceName || "Speaker"; color: root.overlay2; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(12); font.bold: true }
                                    }
                                }
                                Text {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Text { text: root.musicData.positionStr || "00:00"; color: root.overlay2; font.family: "Iosevka Nerd Font"; font.bold: true; font.pixelSize: root.s(13) }
                                Item { Layout.fillWidth: true }
                                Text { text: root.musicData.lengthStr || "00:00"; color: root.overlay2; font.family: "Iosevka Nerd Font"; font.bold: true; font.pixelSize: root.s(13) }
                            }
                        }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text { text: "Equalizer"; color: root.mauve; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(16); font.bold: true; Layout.fillWidth: true }
                        ...
                        Text { text: root.eqData.preset || "Flat"; color: root.subtext0; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(14); font.bold: true; Layout.leftMargin: root.s(15) }
                    }
