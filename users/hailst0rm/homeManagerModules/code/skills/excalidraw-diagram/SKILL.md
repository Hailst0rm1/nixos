...
description: Generate Excalidraw diagrams as PNG renders with structured methodology. Use when the user asks to create a diagram, flowchart, architecture diagram, system visualization, sequence diagram, or any visual explanation. Also triggers on "draw this", "visualize this", "make a diagram of", or explicit /excalidraw.
---
