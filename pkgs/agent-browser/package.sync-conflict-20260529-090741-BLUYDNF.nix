...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    # cargo-auditable 0.6.5 in nixpkgs 25.11 panics in rustc_wrapper.rs:109
    # on this crate's workspace; bypass it for both build and check phases.
    # Upstream nixpkgs has not hit this because they build against newer
    # cargo-auditable.
    auditable = false;
    doCheck = false;
